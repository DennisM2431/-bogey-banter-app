...
async function sendFeedback(){
  ...
  const payload={type,title,body,expected,version:"7.0 RC1.1.1",screen:state.screen,gameMode:state.event?.gameMode||null,playStyle:state.event?.playStyle||null,eventCode:state.eventCode||null,userAgent:navigator.userAgent,platform:navigator.platform||"unknown",viewport:`${innerWidth}x${innerHeight}`};
